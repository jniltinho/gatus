...
- [x] 3.4 Conferência manual: página pública, dashboard e administração em 1280×900 e 390×844; e uma carga com `network route "/fonts/**" --abort`, conferindo que a página continua legível e que a família computada cai na reserva.
...
- [x] 3.7 Entrega: PR em `jniltinho/gatus` com CI verde, release da próxima versão da série com notas em pt-BR, imagem no Docker Hub, pacote `mariadb`, versões dos exemplos e PR de arquivamento.
