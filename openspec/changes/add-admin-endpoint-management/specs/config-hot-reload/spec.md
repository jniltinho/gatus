...
A recarga da configuração MUST repetir a carga dos endpoints gerenciados antes de reiniciar o monitoramento, e MUST impedir escritas da administração entre parar e iniciar o Gatus.
