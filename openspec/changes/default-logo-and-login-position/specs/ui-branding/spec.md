...
O cabeçalho do dashboard, o cabeçalho das páginas públicas de status e o cartão da tela de login MUST mostrar o mesmo logo, definido por `ui.logo`:
- sem `ui.logo`, ou com o valor vazio, o logo MUST ser o embutido no binário, servido em `/logo-192x192.png` sem autenticação;
