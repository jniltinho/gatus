...
## Purpose
A marca que as telas mostram sem configuração: o logo do cabeçalho do dashboard, das páginas públicas de status e dos cartões de login, e como `ui.logo` o troca ou esconde.
## Requirements
