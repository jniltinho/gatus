...
| `ui.custom-css`           | Custom CSS. Loaded before the stylesheet of the application, so rules that override it (for instance the thin scrollbar of the interface) need `!important`. | `""`                                                |
